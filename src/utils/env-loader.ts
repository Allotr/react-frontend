...
export class EnvLoader {
    ...
    private constructor() {
        ...
        const variablesToLoad: Partial<EnvObject> = {
            REACT_APP_WS_API_ENDPOINT: undefined, REACT_APP_HTTPS_API_ENDPOINT: undefined, REACT_APP_GOOGLE_LOGIN_ENDPOINT: undefined, REACT_APP_GOOGLE_LOGOUT_ENDPOINT: undefined
        }
